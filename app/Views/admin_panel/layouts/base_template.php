...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <?= $this->include("admin_panel/layouts/sidebar_view"); ?>
        <!-- End of Sidebar -->
        ...
        <!-- Footer -->
        <?= $this->include("admin_panel/layouts/footer_view"); ?>
        <!-- End of Footer -->
        </div>
    </div>
    <!-- End of Page Wrapper -->
    ...
    <script src="<?= base_url(); ?>/public/admin/js/sb-admin-2.js"></script>
