                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">NTOI Portal Login!</h1>
                                        <?php if (session()->getFlashdata('error')) : ?>
                                            <div id="hideAlert" class="alert alert-danger"><?= session()->getFlashdata('error'); ?></div>
                                        <?php endif; ?>
                                    </div>
                                    <!-- <form class="user"> -->
                                    <?php $attributes = ['class' => 'user']; ?>
                                    ...
                                    <button type="submit" name="loginSubmit" class="btn btn-primary btn-user btn-block">
                                        Login
                                    </button>
                                    <!-- <hr>
