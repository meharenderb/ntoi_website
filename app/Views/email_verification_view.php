                    ...
                    <div class="login-register-box">
                        ...
                        <div class="section-title">
                            ...
                            <?php if (session()->getFlashdata('verified')) : ?>
                                <div id="" class="col alert alert-success"><?= session()->getFlashdata('verified') ?></div>
                            <?php endif; ?>
                            <?php if (session()->getFlashdata('already')) : ?>
                                <div id="" class="col alert alert-success"><?= session()->getFlashdata('already') ?></div>
                            <?php endif; ?>
                            <?php if (session()->getFlashdata('error')) : ?>
                                <div id="" class="col alert alert-danger"><?= session()->getFlashdata('error') ?></div>
                            <?php endif; ?>
                        </div>
                        <!-- Section Title End -->
                    </div>
